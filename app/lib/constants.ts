...
export const KIBRAN_COLOR_HOVER = '#002C55'; // Darker for hover effect
export const KIBRAN_COLOR_LIGHT = '#1A6AA5'; // Slightly darker light blue for contrast
...
// Form Data Constants
export const USER_ROLES = ['Admin', 'Super Admin', 'Store Keeper', 'Sales', 'Cashier'];